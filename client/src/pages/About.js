...
export default function About() {
  return (
    <div className="container" style={{ padding: '2rem 1.5rem', maxWidth: '800px' }}>
      <h1 style={{ fontFamily: 'Playfair Display', marginBottom: '1rem' }}>About TrimTech</h1>

      <section className="card" style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.25rem', marginBottom: '0.5rem' }}>Our Salon</h2>
        <p style={{ color: 'var(--text-secondary)' }}>
          TrimTech is a modern salon that combines traditional grooming expertise with smart technology. 
      ...
      <section className="card" style={{ marginBottom: '1.5rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>
          ...
          in pricing, punctuality, and hygiene—powered by TrimTech’s salon automation system.
        </p>
      </section>
